        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    <NavLink className="navbar-brand" aria-current="page" exact="true" to="/privado">financial tracker</NavLink>
                            ...
                            {usuario &&
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <li><NavLink className="dropdown-item" exact="true" to="transacoes">Transacões</NavLink></li>
                                    </ul>
                                </li>
                            }
                            <li className="nav-item dropdown">
